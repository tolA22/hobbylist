...
module.exports = function defineCustomHook(sails) {
  ...
  return {
    ...
    initialize: async function (done) {
      ...
      var IMPORTANT_TWILIO_CONFIG = ['accountSid', '  authToken','sender'];
      ...
      var isMissingTwilioConfig = _.difference(IMPORTANT_TWILIO_CONFIG, Object.keys(sails.config.custom)).length > 0;
